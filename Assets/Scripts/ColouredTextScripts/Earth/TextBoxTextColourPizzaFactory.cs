...
public class TextBoxTextColourPizzaFactory : MonoBehaviour
{
    ...
    void SetText()
    {
        textBoxText.text = "Requires: \n" + colour1 + "32 Slaves" + colourEnd + "\n" + colour2 + "8 Cleaners" + colourEnd + "\n" + colour3 + "4 Managers" + colourEnd + "\n" + colour4 + "1 Factory" + colourEnd;
    }
